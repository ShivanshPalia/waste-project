...
//         const response = await fetch(`/api/leaderboard?userEmail=${userEmail}`)
...
//           setUser(data.user)
//         } else {
//           toast.error(data.error || 'Failed to load leaderboard. Please try again.')
//         }
//       } catch (error) {
//         console.error('Error fetching leaderboard data:', error)
//         toast.error('Failed to load leaderboard. Please try again.')
//         console.error("hugyughjbuyfgyu")
//       } finally {
//         setLoading(false)
//       }
//     }
