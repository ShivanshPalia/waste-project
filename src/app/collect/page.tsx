...
import { getWasteCollectionTasks, updateTaskStatus, saveReward, saveCollectedWaste, getUserByEmail } from '@/app/actions/action'
...
export default function CollectPage() {
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 max-w-4xl mx-auto">
      ...
      {/* Add a conditional rende.r to show user info or login prompt */}
      {/* {user ? (
